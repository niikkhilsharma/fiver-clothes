  ...
  return (
    <html lang="en">
      ...
      <ThemeContextProvider>
        <body
          className={`antialiased ${comfortaa.variable} ${comfortaa.className} relative bg-gray-50 pt-28 text-gray-950 dark:bg-gray-900 dark:text-gray-50 dark:text-opacity-90 sm:pt-36`}
        >
